...
## Project Overview
- The majority of the customization was done **directly through the Astra theme and WordPress customizer** (colors, typography, layouts, menus, widgets, etc.).
- Some additional effects and styling were added using custom CSS.
- Implemented a GitHub API integration to display my GitHub repositories on the "About Me" page.
- Hosted on InfinityFree, a free web hosting service.

## Features
- Beginner-friendly GitHub tutorials and guides.
- Custom child theme built on Astra.
